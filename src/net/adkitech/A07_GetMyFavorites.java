...
public class A07_GetMyFavorites {
	...
	public JSONArray getMyTweets()
	{
		...
		String twitter_endpoint = "https://api.twitter.com/1.1/favorites/list.json";
		...
		else
		{
			...
			JSONArray arr = new JSONArray(triad.getResponseString());
			int j = 0;
			JSONObject currentTweet = null;
			while(j < arr.length())
			{
				currentTweet = arr.getJSONObject(j);
				System.out.println("id=" + currentTweet.getString("id_str"));
				j++;
			}
			return arr;
		}
	...
	public static void main(String[] args) {
		...
		A07_GetMyFavorites tweetsGetter = new A07_GetMyFavorites();
		JSONArray tweetsArray = tweetsGetter.getMyTweets(); //access_token and access_token_secret should be pasted into A00_ConstantsEditMe for this
	}
